...
- native/hagency/src/console/** (PC-C2's observation routes); native/hagency/src/mcp/** (PC-C3's tools); native/hagency/src/bootstrap/** (PC-C0's wiring); migrations other than 031 (028 MA-S1's, 029 MA-S4's, 030 MA-S2's).
