...
fn native_account_schema22() {
    ...
    sql.execute_batch("DROP TABLE IF EXISTS ceiling_alerts; DROP TABLE resource_accounts; DROP TABLE managed_accounts; DROP TABLE account_identity_key; PRAGMA user_version=22;").unwrap();
